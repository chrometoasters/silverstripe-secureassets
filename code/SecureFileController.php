...
class SecureFileController extends Controller {
	 ...
	 * @param string $name          Optional filename override value
	 * @param string $disposition   Optional content disposition override value
	 * @return bool|string|void
	 */
	public function sendFile($file, $name = '', $disposition = '') {
